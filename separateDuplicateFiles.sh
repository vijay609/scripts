...
# python ./separateDuplicateFiles.py -u /src/data/uniqueFiles.json \
#     -df /src/data/duplicateFiles.json \
#     -d /src/data/duplicates \
#     -i /src/data/test1 /src/data/test2

python ./separateDuplicateFiles.py -u /media/vijay/Data/Pictures/uniqueFiles.json \
    -df /media/vijay/Data/Pictures/duplicateFiles.json \
